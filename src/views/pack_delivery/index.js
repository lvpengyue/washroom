    ...
    watch: {
        async barCode(newV, oldV) {
            if (newV && newV.length > 8) {
                await this.packDeliveryGetData({
                    barCode: this.barCode
                })

                if (this.packDeliveryData && this.packDeliveryData.code != 1) {
                    this.$Message.error({
                        content: this.packDeliveryData.info,
                        duration: 2
                    })
                    ...
                    this.dataList.push(this.packDeliveryData.data);
                }
            }
        }
    },
