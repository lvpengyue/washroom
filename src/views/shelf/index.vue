                    ...
                    <Form inline ref="search" :model="search">
                        ...
                        <FormItem>
                            <Select v-model="search.laundryId" style="width:200px" placeholder="请选择工厂">
                                ...
                                <template v-if="mainBaseData && mainBaseData.data">
                                    <Option :value="item.id" v-for="item in mainBaseData.data.laundryList" :key="item.id">{{item.name}}</Option>
                                </template>
                            </Select>
                        </FormItem>
                        <FormItem>
        ...
        <Modal v-model="editShelf"
            ...
            <div>
                <Form :model="formValidate"
                    ...
                    <FormItem label="工厂" :required="true">
