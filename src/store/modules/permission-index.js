...
const actions = {
    ...
    async permissionIndexGetAdd({
        ...
        try {
            const response = await dispatch('$apisCall', {
                config: $apiConf.API_USER_UPDATE,
                params: params
            });
            ...
            console.log(`新增/编辑失败:${error.code}`);
        }
    },
    ...
    async permissionIndexGetDel({
        ...
        try {
            const response = await dispatch('$apisCall', {
                config: $apiConf.API_USER_DISABLE,
                params: params
            });
            ...
            console.log(`禁用、启用用户失败:${error.code}`);
        }
    },
